...
| Fernanda de Oliveira da Costa | [@nanda-costa](https://github.com/nanda-costa) | Endpoint `GET /api/tasks/{id}/history` de histórico de status, testes de cobertura do comportamento do histórico, documentação do contrato da API, e organização inicial das evidências de captura. | MRs [#8](https://github.com/JulianaBallin/orbit-board-equipe-01/pull/8) e [#9](https://github.com/JulianaBallin/orbit-board-equipe-01/pull/9) |
