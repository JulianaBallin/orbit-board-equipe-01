...
| ------------------------------ | ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| Juliana Ballin Lima           | [@JulianaBallin](https://github.com/JulianaBallin)   | Fundação do projeto: containers, CI, Makefile, README inicial, documentação e relatório iniciais; revisão e integração dos MRs #1 a #10 |
...
| Fernanda de Oliveira da Costa | [@nanda-costa](https://github.com/nanda-costa)       | Endpoint e testes do histórico de status, documentação do contrato da API e evidências de captura       |
